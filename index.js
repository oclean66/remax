...
async function performScraping() {
    axios.put('https://remax-1be58-default-rtdb.firebaseio.com/inmuebles.json', {
    ...
    axios.put('https://remax-1be58-default-rtdb.firebaseio.com/inmuebles.json', nuevaData)
        .then(function (response) {
            console.log(response.statusText, Object.keys(nuevaData).length + " registros agregados");
